...
namespace MensErgerJeNietTests
{
    ...
    public class DobbelstenenTests
    {
        ...
        {
            MensErgerJeNiet.SpeelStuk.SchudBeker beker = new MensErgerJeNiet.SpeelStuk.SchudBeker();

            beker.Dobbelstenen.Add(new MensErgerJeNiet.SpeelStuk.DobbelSteen.Eerlijke.DobbelSteen());
            beker.Dobbelstenen.Add(new MensErgerJeNiet.SpeelStuk.DobbelSteen.Eerlijke.DobbelSteen());
